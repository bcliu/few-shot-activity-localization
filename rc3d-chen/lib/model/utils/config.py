...
# Whether to add ground truth twins to the pool when sampling regions
...
# Size of input frames and crop size (height, width)
...
# Number of top scoring twins to keep before apply NMS to RPN proposals
__C.TRAIN.RPN_PRE_NMS_TOP_N = 12000
# Number of top scoring twins to keep after applying NMS to RPN proposals
...
# Overlap threshold used for non-maximum suppression (suppress twins with
# IoU >= this threshold)
__C.TEST.NMS = 0.3
...
# NOTE: original author uses 1x4x4
# https://github.com/VisionLearningGroup/R-C3D/blob/c1c06aff36a994e0e6078da965654dd0b89f6b7b/experiments/thumos14/train.prototxt
__C.POOLING_LENGTH = 1
__C.POOLING_HEIGHT = 4
__C.POOLING_WIDTH = 4
