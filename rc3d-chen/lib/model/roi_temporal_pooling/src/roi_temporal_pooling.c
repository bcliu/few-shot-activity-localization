                        ...
                        THFloatTensor * features, THFloatTensor * rois, THFloatTensor * output)
{
    ...
    printf("num_rois: %d, size_rois: %d, batch_size: %d, data_length: %d, data_height: %d, data_width: %d, num_channels: %d",
        num_rois, size_rois, batch_size, data_length, data_height, data_width, num_channels);
