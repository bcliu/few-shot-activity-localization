...
ROOT_DATASET = '/home/cs8803throwaway2/disk2/THUMOS14' #'video_datasets'

def return_thumos_fs_dataset(modality):
    filename_categories = 'thumos-fs-category.txt' #'something/category.txt'
    if modality == 'RGB':
        ...
        root_data = '/home/cs8803throwaway2/disk2/THUMOS14/new_frames/fs'
        filename_imglist_train = 'fs_train_videofolder.txt'
        filename_imglist_val = 'fs_val_videofolder.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
        #root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/flow'
        #root_data = '/mnt/localssd1/bzhou/something/flow'
        filename_imglist_train = 'something/train_fs_videofolder.txt'
        filename_imglist_val = 'something/val_fs_videofolder.txt'
        prefix = '{:05d}.jpg'
    else:
...
def return_thumos_dataset(modality):
    filename_categories = 'thumos-ss-category.txt' #'something/category.txt'
    if modality == 'RGB':
        #root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/20bn-something-something-v1'
        #root_data = '/mnt/localssd1/bzhou/something/20bn-something-something-v1'
        root_data = '/home/cs8803throwaway2/disk2/THUMOS14/new_frames/ss'
        filename_imglist_train = 'ss_train_videofolder.txt'
        filename_imglist_val = 'ss_val_videofolder.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
        #root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/flow'
        #root_data = '/mnt/localssd1/bzhou/something/flow'
...
def return_something(modality):
    something_base = '~' # 'something'
    filename_categories = '/home/cs8803throwaway1/category.txt' #'something/category.txt'
    if modality == 'RGB':
        #root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/20bn-something-something-v1'
        #root_data = '/mnt/localssd1/bzhou/something/20bn-something-something-v1'
        root_data = '/home/cs8803throwaway1/20bn-something-something-v1'
        filename_imglist_train = '/home/cs8803throwaway1/train_videofolder.txt'
        filename_imglist_val = '/home/cs8803throwaway1/val_videofolder.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
        #root_data = '/data/vision/oliva/scratch/bzhou/video/something-something/flow'
        #root_data = '/mnt/localssd1/bzhou/something/flow'
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   'charades': return_charades, 'moments': return_moments, 'thumos': return_thumos_dataset, 'thumos-fs': return_thumos_fs_dataset}
