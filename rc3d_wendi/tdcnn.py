...
class _TDCNN(nn.Module):
    ...
    def forward(self, video_data, gt_twins):
        ...
        if self.training:        
            return rois, cls_prob, twin_pred, rpn_loss_cls, rpn_loss_twin, RCNN_loss_cls, RCNN_loss_twin, rois_label, pooled_feat
        else:
            return rois, cls_prob, twin_pred, pooled_feat
